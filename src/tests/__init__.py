...
EOSC_PROJECT_DATA_1 = MPProject(
    id=1452,
    owner=ProjectOwner(
        uid="owner@aai.eosc-portal.eu", email="owner@ut.ee", name="OWNER"
    ),
    project_items=[1, 2, 3],
    attributes=ProjectAttributes(
        ...
        scientific_domains=["Economics & Business"],
        country="Estonia",
...
WALDUR_ORGANIZATION_DATA_1 = [
    {
        ...
        "projects": [{"url": "project_url", "uuid": "project_uuid", "name": "TEST4"}],
        "owners": [
            {
                "url": "owner_url",
                "uuid": "owner_uuid",
...
MOCK_OFFERING_DATA_3 = [
    {
        ...
        "attributes": {
            "vpc_Support_email": "support@hpc.ut.ee",
        ...
        "plans": [
            {
                ...
                "uuid": "plan_uuid",
                "name": "plan_name",
                "prices": {"cores": 0.1, "ram": 0.1, "storage": 0.1},
                "quotas": {"cores": 0, "ram": 0, "storage": 0},
...
EOSC_PROJECT_ITEM_DATA_3 = MPProjectItem(
    id=3,
    project_id=1449,
    status=MPProjectItem.Status(value="registered", type="registered"),
...
EVENTS_4 = [
    Event(
        timestamp=datetime.datetime(
            2021, 8, 10, 13, 17, 45, tzinfo=datetime.timezone.utc
        ),
        type="create",
        resource="project",
        project_id=1453,
    ...
    Event(
        timestamp=datetime.datetime(
            2021, 8, 19, 12, 33, 32, tzinfo=datetime.timezone.utc
        ),
        type="create",
    ...
    Event(
        ...
        message_id=None,
        changes=[
            Event.Change(field="status.type", before="created", after="registered"),
            Event.Change(field="status.value", before="created", after="registered"),
        ],
    ),
]
        ...
        "plans": [
            {
                ...
                "uuid": "plan_uuid",
                "name": "Rocket",
                "prices": {"cpu": 0.1, "gpu": 0.1, "ram": 0.1},
                "quotas": {"cpu": 0, "gpu": 0, "ram": 0},
                "unit_price": "0.0000000",
                "unit": "day",
                "init_price": 0,
                "switch_price": 0,
...
MOCK_GET_EVENTS_6 = [
    Event(
        timestamp=datetime.datetime(
            2021, 9, 28, 10, 57, 27, tzinfo=datetime.timezone.utc
        ),
        type="create",
        resource="project_item",
        project_id=1452,
    ...
    Event(
        timestamp=datetime.datetime(
            2021, 9, 28, 10, 57, 28, tzinfo=datetime.timezone.utc
        ),
        type="update",
        resource="project_item",
        project_id=1452,
